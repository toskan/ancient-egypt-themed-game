let mobilePortrait = window.matchMedia ( "((max-width: 414px)  and (orientation: portrait))" )
let mobileLandscape = window.matchMedia ("(max-width: 823px) and (orientation: landscape)");

if ((mobilePortrait.matches) || (mobileLandscape.matches)) {
